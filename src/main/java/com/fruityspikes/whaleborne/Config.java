...
public class Config {
    ...
    public static final ForgeConfigSpec.BooleanValue HULLBACK_PAUSE_BREACH_TIMER = SERVER_BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue WAKE_RENDERING = CLIENT_BUILDER
