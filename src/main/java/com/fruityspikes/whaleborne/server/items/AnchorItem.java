...
public class AnchorItem extends WhaleEquipment {
    public AnchorItem(Supplier<EntityType<?>> entity, Properties properties) {
        super(entity, properties);
    }
    public AnchorItem(Supplier<EntityType<?>> entity, SoundEvent soundEvent, Properties properties) {
