...
public class WBCreativeTabsRegistry {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TAB =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, Whaleborne.MODID);
    public static final Supplier<CreativeModeTab> WHALEBORNE = CREATIVE_MODE_TAB.register("whaleborne", () -> CreativeModeTab.builder()
