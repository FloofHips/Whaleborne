...
public class WBItemRegistry {
    ...
    public static final RegistryObject<WhaleEquipment> ANCHOR = WBItemRegistry.ITEMS.register("anchor", () -> new WhaleEquipment(WBEntityRegistry.ANCHOR::get, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<ForgeSpawnEggItem> HULLBACK_SPAWN_EGG = WBItemRegistry.ITEMS.register("hullback_spawn_egg", () -> new ForgeSpawnEggItem(WBEntityRegistry.HULLBACK, -5787987,  -9600639, new Item.Properties()));
