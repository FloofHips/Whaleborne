...
public class WBBlockRegistry {
    ...
    public static final RegistryObject<Block> BARNACLE = BLOCKS.register("barnacle", () -> new BarnacleBlock(BlockBehaviour.Properties.of().sound(SoundType.BONE_BLOCK).isRedstoneConductor(WBBlockRegistry::never).mapColor(MapColor.STONE)));
