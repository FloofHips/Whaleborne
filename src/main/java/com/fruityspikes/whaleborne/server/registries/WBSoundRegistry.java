...
public class WBSoundRegistry {
    ...
    public static final Supplier<SoundEvent> SAIL_BLOW = register("entity.sail.blow");
    ...
    public static DeferredHolder<SoundEvent, SoundEvent> register(String name) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(Whaleborne.MODID, name);
